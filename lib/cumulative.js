...
Cumulative.prototype._batchBufferUpdate = function (timeSeriesItem) {
  const oldPoints = this._batchTimeSeries[0].points
  const newPoints = timeSeriesItem.points
  ...
  this._batchTimeSeries[0].points = {
